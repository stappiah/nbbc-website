    ...
    <div className="py-16 bg-gray-100">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-[#0D92F4] mb-4">Join Our Worship Experience</h2>
          <p className="text-xl text-gray-600">(Where faith meets fellowship and joy)</p>
        </div>

        <div className="max-w-4xl mx-auto">
          <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden shadow-xl h-[600px]">
            <iframe
